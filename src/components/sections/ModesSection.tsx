...
const modes = [
  ...
  },
  {
    ...
    label: 'Live Mode',
    labelColor: 'var(--bold)',
    labelBg: 'rgba(184,92,74,0.12)',
    iconBg: 'rgba(184,92,74,0.12)',
    hoverBorder: 'rgba(184,92,74,0.35)',
  ...
  },
  {
    ...
    labelBg: 'rgba(123,111,168,0.12)',
    iconBg: 'rgba(123,111,168,0.12)',
    hoverBorder: 'rgba(123,111,168,0.35)',
